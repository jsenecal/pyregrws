...
class ARINReassignmentTool:
    ...
    def __init__(self, api_key: str, base_url: str = "https://reg.arin.net/rws"):
        ...
        self.countries = {
            ...
            "United States": Iso31661(
                name="United States of America", code2="US", code3="USA", e164=1
            ),
        }
    ...
    def create_customer(
        self, customer_info: CustomerInfo, parent_net: Net
    ) -> Optional[Customer]:
        """
    ...
    def generate_net_name(
        self, network: Union[IPv4Network, IPv6Network], customer_name: str
    ) -> str:
        """
    ...
    def reassign_network(
        ...
        if existing_net and existing_net.handle != parent_net.handle:
            if existing_net.customer_handle:
                print(
                    f"Network {network} is already reassigned to customer {existing_net.customer_handle}"
                )
                return True
            else:
